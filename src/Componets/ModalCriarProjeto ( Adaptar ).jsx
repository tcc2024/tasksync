...
export default function ModalCriarProjeto({modalAberto, setModalAberto, buscarProjeto}) {
    const customStyles = {
        content: {
            top: '50%',
            left: '50%',
...
return (
    ...
    >
        ...
        <input placeholder='Nome Do Projeto' value={tituloProjeto} onChange={(e) => setTituloProjeto(e.target.value)} />
        <input placeholder='Descrição' type='text' value={descricaoProjeto} onChange={(e) => setDescricaoProjeto(e.target.value)} />
